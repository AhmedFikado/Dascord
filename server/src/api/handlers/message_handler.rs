...
#[derive(Clone)]
pub struct MessageHandler<MR: MessageRepository, CR: ChannelRepository, SR: ServerRepository> {
...
impl<MR: MessageRepository, CR: ChannelRepository, SR: ServerRepository> MessageHandler<MR, CR, SR> {
    pub fn new(jwt_service: JWTService, message_repo: MR, channel_repo: CR, server_repo: SR) -> Self {
        Self {
    ...
    pub async fn send_message(
        ...
        let message = handler.send_message_uc.execute(channel_id, user_id, username, content).await?;
