...
#[async_trait]
pub trait PrivateMessageRepository: Send + Sync + Clone {
...
#[derive(Clone)]
pub struct MongoPrivateMessageRepository {
    client: MongoClient,
}

impl MongoPrivateMessageRepository {
...
#[async_trait]
impl PrivateMessageRepository for MongoPrivateMessageRepository {
    async fn create(&self, message: Message) -> AppResult<Message> {
